...
Generate category and product category descriptions automatically using OpenAI's API in multiple languages.
...
2. Generate button on category edit page
3. Example of a generated description
